    ...
    public String toString() {
        return
                "Номер страницы: " + id +
                        ...
                        ", Позиция в физ. памяти: " + indexAtPhysicalMemory +
                        ", Индекс в swap: " + indexAtSwapMemory +
                        ", Бит изменения: " + modificationBit +
                        ", Бит чтения: " + readOrWriteBit +
                        ", Бит необходимости: " + presenceAndAbsenceBit +
                        ", Состав: '" + description + '\'' +
                        '}';
    }
}
